...
DOWNLOAD_DIR="."
DATA_FILE=${DATA_FILE:-udgerdb_v3.dat}
DATA_FILE_SHA1=${DATA_FILE_SHA1:-"${DATA_FILE}.sha1"}
...
VERSION_FILE=${VERSION_FILE:-$DOWNLOAD_DIR/$DATA_FILE.version}
VERSION_FILE_TMP=${VERSION_FILE_TMP:-$DOWNLOAD_DIR/$DATA_FILE.version.tmp}
